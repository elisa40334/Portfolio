window.addEventListener("DOMContentLoaded", async function () {
    ...
    document.querySelectorAll(".stack-card").forEach(async function (el) {
        ...
        el.innerHTML = `
        <div style="font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji; border-radius: 6px; line-height: 1.5; padding: 16px; font-size: 14px; color: white; background-color: #98bae3;">
                ...
                <div style="margin-top: 12px; display: flex; justify-content: space-evenly; align-items: center; ">
                    <div style="margin-top: -4px">
                        ...
                        <div style="font-weight: 400; color: white; font-size: 12px; margin-top: 2px">
                            <span style="font-weight: 600; color: white; font-size: 32px; line-height: 1;">
                                ${reputation}
                            </span>
                        </div>
                    </div>
